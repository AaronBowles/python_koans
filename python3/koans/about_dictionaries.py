...
class AboutDictionaries(Koan):
    ...
    def test_dictionary_keys_and_values(self):
        ...
        self.assertEqual('uno', 'one' in babel_fish.keys())
        self.assertEqual('dos', 'two' in babel_fish.values())
        self.assertEqual('one', 'uno' in babel_fish.keys())
        self.assertEqual('two', 'dos' in babel_fish.values())
