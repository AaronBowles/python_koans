...
class AboutLists(Koan):
    ...
    def test_slicing_lists(self):
        ...
        self.assertEqual(['jelly', 'and', 'butter'], noms[4:0])
    ...
    def test_slicing_to_the_edge(self):
        ...
        self.assertEqual(['peanut', 'butter', 'jelly'], noms[2:])
        self.assertEqual(['peanut', 'butter', 'jelly'], noms[:2])
    ...
    def test_insertions(self):
        ...
        self.assertEqual(['Arthur', 'you', 'shall', 'pass'], knight)
    ...
    def test_popping_lists(self):
        ...
        self.assertEqual([20,30,40], stack)
